    ...
    <div>
          ...
          <Card bg="primary" text="white" className="mb-4">
            <CardBody className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div>{siteData.dashboard.featured.user}</div>
              </div>
              <Dropdown align="end">
                <DropdownToggle
                  as="button"
                ...
                <DropdownMenu>
                  <DropdownItem href="#/action-1">{siteData.dashboard.featured.action.action1}</DropdownItem>
                  <DropdownItem href="#/action-2">{siteData.dashboard.featured.action.action2}</DropdownItem>
                  <DropdownItem href="#/action-3">{siteData.dashboard.featured.action.action3}</DropdownItem>
                </DropdownMenu>
              </Dropdown>
            </CardBody>
          ...
          <Card bg="info" text="white" className="mb-4">
            <CardBody className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div>{siteData.dashboard.featured.income}</div>
              </div>
              <Dropdown align="end">
                <DropdownToggle
                  as="button"
          ...
          <Card bg="warning" text="white" className="mb-4">
            <CardBody className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div>{siteData.dashboard.featured.conversion_rate}</div>
              </div>
              <Dropdown align="end">
                <DropdownToggle
                  as="button"
          ...
          <Card bg="danger" text="white" className="mb-4">
            <CardBody className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div>{siteData.dashboard.featured.sessions}</div>
              </div>
              <Dropdown align="end">
                <DropdownToggle
                  as="button"
      ...
      <Card className="mb-4">
        <CardBody>
          <div className="d-flex justify-content-between">
            <div>
              <h4 className="mb-0">{siteData.dashboard.traffic.title}</h4>
              <div className="small text-black-50 dark:text-gray-500">{siteData.dashboard.traffic.duration}</div>
            </div>
            <div className="d-none d-md-block">
              <ButtonGroup aria-label="Toolbar with buttons" className="mx-3">
                ...
                <label
                  ...
                  htmlFor="option1"
                >
                  {siteData.dashboard.traffic.option.day}
                </label>
                <input
                  className="btn-check"
                  id="option2"
                ...
                <label
                  ...
                  htmlFor="option2"
                >
                  {siteData.dashboard.traffic.option.month}
                </label>
                <input
                  className="btn-check"
                  id="option3"
                ...
                <label
                  ...
                  htmlFor="option3"
                >
                  {siteData.dashboard.traffic.option.year}
                </label>
              </ButtonGroup>
        ...
        <CardFooter>
          <div className="row row-cols-1 row-cols-md-5 text-center">
            <div className="col mb-sm-2 mb-0">
              <div className="text-black-50 dark:text-gray-500">{siteData.dashboard.traffic.category1}</div>
              <div className="fw-semibold">
                29.703
                {siteData.dashboard.traffic.users}
                {' '}
                (40%)
              </div>
              <ProgressBar
            ...
            <div className="col mb-sm-2 mb-0">
              <div className="text-black-50 dark:text-gray-500">{siteData.dashboard.traffic.category2}</div>
              <div className="fw-semibold">
                24.093
                {siteData.dashboard.traffic.users}
                {' '}
            ...
            <div className="col mb-sm-2 mb-0">
              <div className="text-black-50 dark:text-gray-500">{siteData.dashboard.traffic.category3}</div>
              <div className="fw-semibold">
                78.706
                {siteData.dashboard.traffic.views}
                {' '}
                (60%)
              </div>
              <ProgressBar
            ...
            <div className="col mb-sm-2 mb-0">
              <div className="text-black-50 dark:text-gray-500">{siteData.dashboard.traffic.category4}</div>
              <div className="fw-semibold">
                22.123
                {siteData.dashboard.traffic.users}
                {' '}
            ...
            <div className="col mb-sm-2 mb-0">
              <div className="text-black-50 dark:text-gray-500">{siteData.dashboard.traffic.category5}</div>
              ...
              <div className="row text-center">
                <div className="col">
                  ...
                  <div className="text-uppercase text-black-50 dark:text-gray-500 small">
                    {siteData.dashboard.social.facebook.label1}
                  </div>
                </div>
                ...
                <div className="col">
                  ...
                  <div className="text-uppercase text-black-50 dark:text-gray-500 small">
                    {siteData.dashboard.social.facebook.label2}
                  </div>
                </div>
              </div>
            </CardBody>
            ...
            <CardBody>
              <div className="row text-center">
                <div className="col">
                  ...
                  <div className="text-uppercase text-black-50 dark:text-gray-500 small">
                    {siteData.dashboard.social.twitter.label1}
                  </div>
                </div>
                <div className="vr p-0" />
                <div className="col">
                  ...
                  <div className="text-uppercase text-black-50 dark:text-gray-500 small">
                    {siteData.dashboard.social.twitter.label2}
                  </div>
                </div>
              </div>
            </CardBody>
            ...
            <CardBody>
              <div className="row text-center">
                <div className="col">
                  ...
                  <div className="text-uppercase text-black-50 dark:text-gray-500 small">
                    {siteData.dashboard.social.instagram.label1}
                  </div>
                </div>
                <div className="vr p-0" />
                <div className="col">
                  ...
                  <div className="text-uppercase text-black-50 dark:text-gray-500 small">
                    {siteData.dashboard.social.instagram.label2}
                  </div>
                </div>
              </div>
            </CardBody>
      ...
      <div className="row">
        <div className="col-md-12">
          <Card>
            <CardHeader>
              {siteData.dashboard.sales.title}
            </CardHeader>
            <CardBody>
              <div className="row">
                <div className="col-sm-6">
                  <div className="row">
                    <div className="col-6">
                      <div className="border-start border-4 border-info px-3 mb-3">
                        <small className="text-black-50 dark:text-gray-500">
                          {siteData.dashboard.sales.stats.stat1}
                        </small>
                    ...
                    <div className="col-6">
                      <div className="border-start border-4 border-danger px-3 mb-3">
                        <small className="text-black-50 dark:text-gray-500">
                          {siteData.dashboard.sales.stats.stat2}
                        </small>
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.monday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.tuesday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.wednesday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.thursday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.friday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.saturday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row mb-4 align-items-center">
                    <div className="col-3">
                      <span className="text-black-50 dark:text-gray-500 small">
                        {siteData.dashboard.sales.sunday}
                      </span>
                    </div>
                    <div className="col">
                      <ProgressBar
                  ...
                  <div className="row">
                    <div className="col-6">
                      <div className="border-start border-4 border-warning px-3 mb-3">
                        <small className="text-black-50 dark:text-gray-500">
                          {siteData.dashboard.sales.stats.stat3}
                        </small>
                    ...
                    <div className="col-6">
                      <div className="border-start border-4 border-success px-3 mb-3">
                        <small className="text-black-50 dark:text-gray-500">
                          {siteData.dashboard.sales.stats.stat4}
                        </small>
                ...
                <table className="table border mb-0">
                  <thead className="fw-semibold">
                    <tr className="align-middle table-light dark:table-dark">
                      ...
                      <th className="text-center">{siteData.dashboard.listing.headers.header3}</th>
                      <th>{siteData.dashboard.listing.headers.header4}</th>
                  ...
                  <tbody>
                    <tr className="align-middle">
                      ...
                      <td>
                        <div>{siteData.dashboard.listing.items.item1.name}</div>
                        <div className="small text-black-50 dark:text-gray-500">
                          <span>{siteData.dashboard.listing.user_status.new}</span>
                          {' '}
                          |
                          {' '}
                          {siteData.dashboard.listing.registered}
                          :
                          {' '}
                          {siteData.dashboard.listing.registered_at}
                        </div>
                      </td>
                      <td>
                        <div className="clearfix">
                          ...
                          <div className="float-end">
                            <small className="text-black-50 dark:text-gray-500">
                              {siteData.dashboard.listing.usage_duration}
                            </small>
                          </div>
                        </div>
                      ...
                      <td>
                        ...
                        <div className="fw-semibold">{siteData.dashboard.listing.items.item1.login_at}</div>
                      </td>
                      <td>
                        <Dropdown align="end">
                          <DropdownToggle
                          ...
                          <DropdownMenu>
                            <DropdownItem href="#/action-1">{siteData.action.info}</DropdownItem>
                            <DropdownItem href="#/action-2">{siteData.action.edit}</DropdownItem>
                            <DropdownItem
                              className="text-danger"
                              href="#/action-3"
                            >
                              {siteData.action.delete}
                            </DropdownItem>
                          </DropdownMenu>
                        </Dropdown>
                      </td>
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div>{siteData.dashboard.listing.items.item2.name}</div>
                        <div className="small text-black-50 dark:text-gray-500">
                          <span>{siteData.dashboard.listing.user_status.recurring}</span>
                          {' '}
                          |
                          {' '}
                          {siteData.dashboard.listing.registered}
                      ...
                      <td>
                        <div className="small text-black-50 dark:text-gray-500">{siteData.dashboard.listing.last_login}</div>
                        <div className="fw-semibold">{siteData.dashboard.listing.items.item2.login_at}</div>
                      </td>
                      <td>
                        <Dropdown align="end">
                          <DropdownToggle
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div>{siteData.dashboard.listing.items.item3.name}</div>
                        <div className="small text-black-50 dark:text-gray-500">
                          <span>{siteData.dashboard.listing.user_status.new}</span>
                          {' '}
                          |
                      ...
                      <td>
                        <div className="small text-black-50 dark:text-gray-500">{siteData.dashboard.listing.last_login}</div>
                        <div className="fw-semibold">{siteData.dashboard.listing.items.item3.login_at}</div>
                      </td>
                      <td>
                        <Dropdown align="end">
                          <DropdownToggle
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div>{siteData.dashboard.listing.items.item4.name}</div>
                        <div className="small text-black-50 dark:text-gray-500">
                          <span>{siteData.dashboard.listing.user_status.new}</span>
                          {' '}
                          |
                      ...
                      <td>
                        <div className="small text-black-50 dark:text-gray-500">{siteData.dashboard.listing.last_login}</div>
                        <div className="fw-semibold">{siteData.dashboard.listing.items.item4.login_at}</div>
                      </td>
                      <td>
                        <Dropdown align="end">
                          <DropdownToggle
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div>{siteData.dashboard.listing.items.item5.name}</div>
                        <div className="small text-black-50 dark:text-gray-500">
                          <span>{siteData.dashboard.listing.user_status.new}</span>
                          {' '}
                          |
                      ...
                      <td>
                        <div className="small text-black-50 dark:text-gray-500">{siteData.dashboard.listing.last_login}</div>
                        <div className="fw-semibold">{siteData.dashboard.listing.items.item5.login_at}</div>
                      </td>
                      <td>
                        <Dropdown align="end">
                          <DropdownToggle
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div>{siteData.dashboard.listing.items.item6.name}</div>
                        <div className="small text-black-50 dark:text-gray-500">
                          <span>{siteData.dashboard.listing.user_status.new}</span>
                          {' '}
                          |
                      ...
                      <td>
                        <div className="small text-black-50 dark:text-gray-500">{siteData.dashboard.listing.last_login}</div>
                        <div className="fw-semibold">{siteData.dashboard.listing.items.item6.login_at}</div>
                      </td>
                      <td>
                        <Dropdown align="end">
                          <DropdownToggle
