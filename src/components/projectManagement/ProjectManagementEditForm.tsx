...
const ProjectManagementEditForm = ({categoriesData ,form, onSubmit, loading, buttonText = "Submit", projectImage, setProjectImage,setImageRemoved }: any) => {
...
export default ProjectManagementEditForm
